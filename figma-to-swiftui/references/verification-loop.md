...
2. Replace `Image(systemName: "shield.fill")` with `Image(.icAIShield)` (the Figma source, iOS 17+ auto-generated `ImageResource`). If a system glyph is genuinely correct, add `// allow-systemName: <reason>` directly above the call site.
